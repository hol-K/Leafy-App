...
class LeafyTheme {
  ...
  static const Color vampireBlack = Color(0xFF0A1511); // Texte et éléments sombres
  ...
  static ThemeData get lightTheme {
    return ThemeData(
      useMaterial3: true,
      scaffoldBackgroundColor: brightGray, // Applique le gris très clair au fond
      ...
      inputDecorationTheme: InputDecorationTheme(
        ...
        border: OutlineInputBorder(
          borderRadius: BorderRadius.circular(30), // Bordures très arrondies comme sur le design
          borderSide: BorderSide.none,
        ),
        prefixIconColor: davyGrey,
      ),

      // Style de la barre de navigation (BottomNavBar)
      bottomNavigationBarTheme: const BottomNavigationBarThemeData(
        backgroundColor: Colors.transparent, // Sera géré par notre widget flottant
